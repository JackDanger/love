...
function Module:getToTypeName(type)
    return "mod_to_"..string.lower(type)
end
...
function Module:getFuse(type, method)
    return "_wrap_method_" .. type .. "_" .. method
end
...
-- Add stuff at the start.
function Module:prepend()
    local i = 1
...
-- Adds stuff to the end ofthe SWIG-wrapper.
function Module:add()
