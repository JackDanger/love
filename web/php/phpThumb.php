...
ob_start();
if (!include_once(dirname(__FILE__).'/phpThumb/phpthumb.class.php')) {
	ob_end_flush();
	die('failed to include_once("'.realpath(dirname(__FILE__).'/phpThumb/phpthumb.class.php').'")');
}
ob_end_clean();
...
if (file_exists(dirname(__FILE__).'/phpThumb/phpThumb.config.php')) {
	ob_start();
	if (include_once(dirname(__FILE__).'/phpThumb/phpThumb.config.php')) {
		// great
	} else {
		ob_end_flush();
		$phpThumb->ErrorImage('failed to include_once('.dirname(__FILE__).'/phpThumb/phpThumb.config.php) - realpath="'.realpath(dirname(__FILE__).'/phpThumb/phpThumb.config.php').'"');
	}
	ob_end_clean();
} elseif (file_exists(dirname(__FILE__).'/phpThumb/phpThumb.config.php.default')) {
