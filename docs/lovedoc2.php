...
class LoveDoc2
{
  ...
  public static function to_html($string)
  {
    ...
    $tmp = replace_lua($string);
  
    // Replace brackets with html tags.
    $html = trim(str_replace(array("[", "]"), array("<", ">"),$tmp));
  ...
  public function push($name, $attributes)
  {
    ...
    switch($name)
    {
      ...
      case "device":
           ...
           break;
      case "function":
           array_push($this->stack, new Func($name, $attributes));
           break;
      case "callback":
           array_push($this->stack, new Callback($name, $attributes));
           break;
      case "method":
...
class Type extends Element
{
  ...
  public function html()
  {
    // Generate HTML.
     ...
     foreach($this->children as $c)
       if($c->typeof("method") || $c->typeof("separator"))
         $html .= $c->html_listitem();
...
class Method extends Element
{
  ...
  public function write()
  {
    ...
    $parent = $this->atr("parent") == "" ? "" : $this->atr("parent").$this->getSeparator();
...
class Callback extends Method
{
  public function write()
  {
    ...
    // Create html.
    LoveDoc2::write_html_sym($html, "Callback", $partial, $full);
