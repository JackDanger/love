...
main = {
	...
	init = function()
		...
		-- Images
		game:addImage('image01', 'data/pig.gif');
		game:addImage('eiffel', 'data/games/test/img/eiffel.jpg');
		game:addImage('hamster', 'data/hamster.gif');
		game:addImage('mortis', 'data/mortis.gif');
