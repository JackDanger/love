...
#define FMOD_VERSION    0x00040300
...
typedef enum
{
    ...
    FMOD_OUTPUTTYPE_DSOUND,          /* Win32/Win64 - DirectSound output.  Use this to get EAX Reverb support. (Default on Windows) */
...
{                                   /*          MIN     MAX     DEFAULT  DESCRIPTION */
    ...
    float        RoomRolloffFactor; /* [in/out] 0.0   , 10.0  , 0.0    , like rolloffscale in System::set3DSettings but for reverb room size effect (win32/Xbox) */
...
#define FMOD_REVERB_FLAGS_HIGHQUALITYREVERB     0x00000400 /* GameCube only. Use high quality reverb */
...
FMOD_RESULT F_API FMOD_Channel_Set3DSubChannelOffset (FMOD_CHANNEL *channel, int subchannel, FMOD_VECTOR *offset);
FMOD_RESULT F_API FMOD_Channel_Get3DSubChannelOffset (FMOD_CHANNEL *channel, int subchannel, FMOD_VECTOR *offset);
