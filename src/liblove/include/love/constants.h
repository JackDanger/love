...
namespace love
{
	...
	enum
	{
		GAMEPAD_AXIS_HORIZONTAL = 0,
		GAMEPAD_AXIS_VERITCAL = 1,
		GAMEPAD_HAT_CENTERED = 0,
		GAMEPAD_HAT_UP = 1,
		GAMEPAD_HAT_RIGHT = 2,
		GAMEPAD_HAT_DOWN = 4,
		GAMEPAD_HAT_LEFT = 8,
		GAMEPAD_HAT_RIGHTUP = (GAMEPAD_HAT_RIGHT|GAMEPAD_HAT_UP), // 3
		GAMEPAD_HAT_RIGHTDOWN = (GAMEPAD_HAT_RIGHT|GAMEPAD_HAT_DOWN), // 6
		GAMEPAD_HAT_LEFTUP = (GAMEPAD_HAT_LEFT|GAMEPAD_HAT_UP), // 9
		GAMEPAD_HAT_LEFTDOWN = (GAMEPAD_HAT_LEFT|GAMEPAD_HAT_DOWN) // 12
	};
