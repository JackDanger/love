...
#define LOVE_VERSION_MINOR 3
#define LOVE_VERSION_REV 1
#define LOVE_VERSION_STR "0.3.1"
#define LOVE_VERSION_COMPATIBILITY LOVE_VERSION_STR " 0.2.1 0.3.0"
#define LOVE_VERSION_CODENAME "Space Meat"
