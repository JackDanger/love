...
#define LOVE_VERSION_MINOR 4
#define LOVE_VERSION_REV 0
#define LOVE_VERSION_STR "0.4.0"
#define LOVE_VERSION_COMPATIBILITY LOVE_VERSION_STR " 0.2.1 0.3.0 0.3.1 0.3.2"
#define LOVE_VERSION_CODENAME "Taco Beam"
