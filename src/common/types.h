...
namespace love
{
	...
	const bits LOVE_GRAPHICS_FRAME_BITS = (bits(1) << LOVE_GRAPHICS_FRAME_ID) | LOVE_GRAPHICS_DRAWABLE_BITS;
	...
	const bits LOVE_AUDIO_CHANNEL_BITS = (bits(1) << LOVE_AUDIO_CHANNEL_ID) | LOVE_OBJECT_BITS;
