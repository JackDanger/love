...
#define SWIG_name      "mod_sdlsystem"
#define SWIG_init      luaopen_mod_sdlsystem
#define SWIG_init_user luaopen_mod_sdlsystem_user

#define SWIG_LUACODE   luaopen_mod_sdlsystem_luacode
